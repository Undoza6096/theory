...
var id = "DBS";
var name = "Discord Boosts Simulators";
...
var init = () => {
    currency = theory.createCurrency("B", "B");
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(1, currency, new ExponentialCost(7, Math.log2(10)));
    ...
    // q1
    {
        ...
        q1 = theory.createUpgrade(2, currency, new ExponentialCost(14, Math.log2(10)));
...
var tick = (elapsedTime, multiplier) => {
    ...
    currency.value += dt * bonus * getC1(c1.level) * getC2(c2.level) * dt * getQ1(q1.level);
}
...
var getPublicationMultiplier = (tau) => tau.pow(0.180) / BigNumber.THREE;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{0.180}}{3}";
